...
public abstract class $Toolbar_Drawer_ViewPager_Activity extends $Toolbar_ViewPager_Activity
{
	...
	protected int _getTemplateLayoutId()
	{
		if(_hasCollapsingToolbar()){
			return R.layout.nnl_collapsing_toolbar_drawer_viewpager_layout;
		}else{
			return R.layout.nnl_toolbar_drawer_viewpager_layout;
		}
	}
}
